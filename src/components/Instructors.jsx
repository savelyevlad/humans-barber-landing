    ...
    <section className="code-section bg-gray-50 dark:bg-gray-900 py-16 lg:py-24" id="instructors">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-gray-100 border border-gray-300 px-4 py-2 rounded-full mb-6">
            <i className="fas fa-user-tie text-[var(--primary-color)]" aria-hidden="true"></i>
            <span className="text-[var(--dark-text-color)] text-sm font-medium" data-translate="teamBadge">{t('teamBadge')}</span>
          </div>
